...
The intended function of tracker was for calendar to be incorporated into it with the workout and tracker. Where the user would enter a clickable calendar date, then proceed to the next area which would open the workout.java allowing the user to enter the data by adding and removing workouts.
